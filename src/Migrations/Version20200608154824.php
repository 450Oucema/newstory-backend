 ...
 */
final class Version20200608154824 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE alert ADD icon VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE alert DROP icon');
        $this->addSql('ALTER TABLE friend_request CHANGE accepted accepted TINYINT(1) DEFAULT \'NULL\', CHANGE response_date response_date DATETIME DEFAULT \'NULL\'');
