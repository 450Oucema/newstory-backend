 ...
 */
final class Version20200607095605 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE friend_request ADD accepted TINYINT(1) NOT NULL, ADD created_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE friend_request DROP accepted, DROP created_at');
